...
\begin{equation}
    p_i = (\gamma - 1) \rho e_i,
\end{equation}
where $e_i = \sum_s^N Y_{i,s} e_{i,s}$. Thus, given that $\gamma = 5/3$, the internal energy equation for ions given by \cref{eq:sf_sm_ms_iei} becomes
\begin{equation*}
    \frac{\partial \rho e_i}{\partial t} + \nabla \cdot \left( \rho e_i \uvec \right) = \sigmavec_i : \nabla \uvec - \nabla \cdot \qvec_i + Q_i.
\end{equation*}
Similarly, the internal energy equation for electrons given by \cref{eq:sf_sm_ms_iee} becomes
\begin{equation*}
    \frac{\partial \rho Y_e e_e}{\partial t} + \nabla \cdot \left( \rho Y_e e_e \uvec \right) = \sigmavec_e : \nabla \uvec - \nabla \cdot \qvec_e + Q_e - \nabla \cdot \left( \rho Y_e e_e \wvec_e \right) + \sigmavec_e : \nabla \wvec_e.
\end{equation*}
We re-write the last term above as
\begin{align*}
    \sigmavec_e : \nabla \wvec_e &= \nabla \cdot \left( \wvec_e \cdot \sigmavec_e \right) - \wvec \cdot \nabla \sigmavec_e \\
    &= -\nabla \cdot (p_e \wvec ) + \nabla \cdot \left( \wvec_e \cdot \tvec_e \right) - \wvec_e \cdot \nabla \sigmavec_e. 
\end{align*}
Thus, the electron internal energy equation becomes
\begin{equation*}
    \frac{\partial \rho Y_e e_e}{\partial t} + \nabla \cdot \left( \rho Y_e e_e \uvec \right) = \sigmavec_e : \nabla \uvec - \nabla \cdot \qvec_e + Q_e -\nabla \cdot \left[ \left( e_e + \frac{p_e}{\rho Y_e} \right) \rho Y_e \wvec_e \right] + \nabla \cdot \left( \wvec_e \cdot \tvec_e \right) - \wvec_e \cdot \nabla \sigmavec_e,
\end{equation*}
or
\begin{equation*}
...
\begin{equation}
    e = e_i + Y_e e_e,
\end{equation}
so that adding up the ion and electron internal energy equations gives
\begin{multline*}
