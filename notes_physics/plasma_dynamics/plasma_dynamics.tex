...
\end{equation}
where $\bar{\Evec}_{1,t} = \bar{\Evec}_{1,t}(\xvec)$ and $\bar{\Bvec}_{1,t} = \bar{\Bvec}_{1,t}(\xvec)$. Also introduce $\uvec_{e1,t} = \bar{\uvec}_{e1,t} e^{-iwt}$. Using this in the wave equations above we get
\begin{equation}
...
\end{equation}
and thus the wave equations become
\begin{equation}
    -w^2 \bar{\Evec}_{1,t} - \frac{1}{\epsilon_0 \mu_0} \nabla^2 \bar{\Evec}_{1,t} + w_{pe}^2 \bar{\Evec}_{1,t} = 0,
\end{equation}
\begin{equation}
...
\end{equation}
We now use Faraday's equation again, that is 
\begin{equation}
...
\end{equation}
Using the vector identity $\nabla \times (f \Fvec) = f \nabla \times \Fvec + \nabla f \times \Fvec$, the wave equations finally become 
\begin{equation}
    -w^2 \bar{\Evec}_{1,t} - \frac{1}{\epsilon_0 \mu_0} \nabla^2 \bar{\Evec}_{1,t} + w_{pe}^2 \bar{\Evec}_{1,t} = 0,
\end{equation}
\begin{equation}
