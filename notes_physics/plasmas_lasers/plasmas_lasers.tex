...
%------------------------------------------------------------------------
\section{Multi-fluid multi-species formulation}
%------------------------------------------------------------------------
\begin{enumerate}
    \item Species are separated into two categories: ions and electrons.
    \item No sources ($\hat{S}_\alpha$, $\hat{\Mvec}_\alpha$, $\hat{Q}_\alpha$).
\end{enumerate}
Thus, the governing equations are
\begin{equation}
    \label{eq:mf_ms_ni}
    \frac{\partial n_{i,\alpha}}{\partial t} + \nabla \cdot \left ( n_{i,\alpha} \uvec_{i,\alpha} \right ) = 0,
\end{equation}
\begin{equation}
    \label{eq:mf_ms_ne}
    \frac{\partial n_{e,\alpha}}{\partial t} + \nabla \cdot \left ( n_{e,\alpha} \uvec_{e,\alpha} \right ) = 0,
\end{equation}
\begin{equation}
    \label{eq:mf_ms_ui}
    \frac{\partial m_{i,\alpha} n_{i,\alpha} \uvec_{i,\alpha}}{\partial t} + \nabla \cdot \left( m_{i,\alpha} n_{i,\alpha} \uvec_{i,\alpha} \uvec_{i,\alpha} \right) - Z_{i,\alpha} e n_{i,\alpha} ( \Evec + \uvec_{i,\alpha} \times \Bvec ) = \nabla \cdot \sigmavec_{i,\alpha} + \Rvec_{i,\alpha},
\end{equation}
\begin{equation}
    \label{eq:mf_ms_ue}
...
%------------------------------------------------------------------------
\section{Multi-fluid single-species formulation}
%------------------------------------------------------------------------

\label{sec:mf_ss_equations}
In this section we simplify the approach to consider a single ion species and a single electron species. Thus, the governing equations are
\begin{equation}
    \label{eq:mf_ss_ni}
...
%------------------------------------------------------------------------
\section{Single-fluid multi-species formulation}
%------------------------------------------------------------------------

%------------------------------------------------------------------------
\section{Single-fluid single-species formulation}
%------------------------------------------------------------------------

%------------------------------------------------------------------------
\section{Isentropic plasmas}
%------------------------------------------------------------------------
