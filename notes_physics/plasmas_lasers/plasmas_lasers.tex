...
%--------------------------------------------
In this section we derive the total sum across all species of the collisional terms $\Rvec_\alpha$ and $Q_\alpha$. Use \cref{eq:mom_collision_expansion} to re-write $\Rvec_\alpha$ as
\begin{equation*}
...
%--------------------------------------------
\subsection{Summary of single-fluid equations}
%--------------------------------------------
...
Thus far we've been working with plasmas that behave as ideal gasses with three degrees of freedom (the three translational degrees of freedom). For ideal gasses we also have $p_\alpha = (\gamma - 1) \rho Y_\alpha e_\alpha$, where $e_\alpha$ is the internal energy of the any species, either ions or electrons. Thus, the internal energy equations become
\begin{equation*}
...
%------------------------------------------------------------------------
The starting point are the single-fluid equations of \cref{sec:sf_summary}. We'll also assume all ions move with a single velocity $\uvec_i$. Thus, 
\begin{equation}
...
The momentum equation can thus be written as
\begin{equation*}
...
%--------------------------------------------
\subsection{Ion internal energy equation}
%--------------------------------------------
...
%--------------------------------------------
\subsection{Electron internal energy equation}
%--------------------------------------------
...
%--------------------------------------------
We'll assume all ions have the same temperature $T_i$. Thus, the EOS for each ion becomes
\begin{equation*}
...
%--------------------------------------------
\subsection{Summary of single-fluid MHD equations}
%--------------------------------------------
