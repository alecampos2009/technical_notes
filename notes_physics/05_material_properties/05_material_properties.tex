...
\end{equation}
The scattering angle is the value of $\tilde{\varphi}$ as $\tilde{r}$ goes to infinity. Using \cref{eq:coul_trajectory_eq}, and labeling this angle as $\tilde{\varphi}_\infty$ we have
\begin{equation*}
    0 = \sin \tilde{\varphi}_\infty + \frac{b_{90}}{b} \left ( \cos \tilde{\varphi}_\infty - 1 \right ).
\end{equation*}
We express the above in terms of $\tilde{\theta}_\infty$,
\begin{equation*}
    0 = \sin (\pi - \tilde{\theta}_\infty) + \frac{b_{90}}{b} \left [ \cos \left (\pi - \tilde{\theta}_\infty \right ) - 1 \right ].
\end{equation*}
or
\begin{equation*}
    0 = \sin \tilde{\theta}_\infty + \frac{b_{90}}{b} \left ( -\cos \tilde{\theta}_\infty - 1 \right ).
\end{equation*}
Re-writing the above as
\begin{equation}
    \frac{\cos \tilde{\theta}_\infty + 1}{\sin \tilde{\theta}_\infty} = \frac{b}{b_{90}},
\end{equation}
and using the trig identity $\cot (\theta/2) = (\cos \theta + 1) / \sin \theta$, we get 
\begin{equation}
    \cot \left ( \frac{\tilde{\theta}_\infty}{2} \right ) = \frac{b_{90}}{b}.
\end{equation}
