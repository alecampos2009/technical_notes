...
\begin{equation}
    ...
    \hat{\sigmavec_{k,e}} = \eta_k \sigmavec_{k,e}.
\end{equation}

\subsubsection{Number densities}
\begin{equation}
    n_{k,i,s} = \frac{\mathsf{N}_{k,i,s}}{\mathsf{V}_k}.
\end{equation}
\begin{equation}
    n_{k,e} = \frac{\mathsf{N}_{k,e}}{\mathsf{V}_k}.
\end{equation}
\begin{equation}
    \hat{n}_{k,i,s} = \frac{\mathsf{N}_{k,i,s}}{\mathsf{V}}.
\end{equation}
\begin{equation}
    \hat{n}_{k,e} = \frac{\mathsf{N}_{k,e}}{\mathsf{V}}.
\end{equation}
\begin{equation}
